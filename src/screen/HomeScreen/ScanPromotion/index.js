...
class Scanner extends Component {
	...
	async onBarCodeRead(scanResult) {
		if (scanResult.data != null) {
			this.props.ScanOK(scanResult.data);
		}
		return;
	}
		...
		return (
			<View style={styles.container}>
				...
				<View style={[ styles.overlay, styles.topOverlay ]}>
					<Text style={styles.scanScreenMessage}>POPEYES SCAN PROMOTION</Text>
				</View>

				<TouchableOpacity onPress={() => this.props.cancelScan()} style={styles.buttonCancel}>
